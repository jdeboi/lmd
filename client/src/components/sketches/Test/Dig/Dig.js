  ...
  render() {
    ...
    return (
      <div className="Dig" ref={this.divRef} >
        ...
        <DesktopIcon disableWindow={true} onDblClick={() => this.onDblClick(0)} x={100} y={220} width={60} height={90} title="dive" box={box}
          title={"z-axis"}
          content={
        ...
        {frames.map((frame) => {
          ...
          return (
            <Frame
              ...
              height={300}
              title="work"
              windowStyle={{ background: "red" }}
              content={
                <div onDoubleClick={(event) => this.clicked(frame)}>

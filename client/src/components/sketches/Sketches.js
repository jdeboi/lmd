...
export const rooms = [
    ...
    { id: 9, short: "blind", link: "blinds", title: "blinds", x: 15, y: 0, rot: 0, dir: "bottom", about: "How does the white cube translate into cyber-dimensions? What social and economic barriers (for example, systemic racism) prevent access to the art world, and how do these barriers operate online?", shortcut: "&#x2318;9", year: 2021 },

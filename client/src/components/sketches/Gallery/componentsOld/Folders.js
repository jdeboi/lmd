...
export default function (props) {
  ...
  return (
    <div className="folders">
      ...
      />
      <DesktopIcon title={"thesis"} x={props.x + 80} y={props.y + 130} disableWindow={true} bounded={false} onDblClick={() => openInNewTab("http://losingmydimension.com/thesis.pdf")}
         content={
          <img src={window.AWS + "/waveforms/txt.png"} width={80} height={80} />
        }
      />
      <DesktopIcon title={"instagram"} x={props.x - 30} y={props.y + 230} disableWindow={true} bounded={false} onDblClick={() => openInNewTab("https://www.instagram.com/jdeboi/")}
        content={
          <img src={window.AWS + "/gallery/instagram.png"} width={80} height={80} />
        }
      />
    </div>
  )
